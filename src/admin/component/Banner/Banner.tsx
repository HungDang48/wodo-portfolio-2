...
const Banner = () => {
  return (
    <div className="banner">
      <img src="/img/BWC2_LOGO.png" alt="Banner" className="banner-image" />
  ...
  <div className="left-logo-text-group">
    ...
    <span className="left-logo-text2">Thành viên thứ 170 của WOSM</span>
      ...
      <div className="overlay-logos">
        ...
        <img src="/img/dien-hai.png" alt="Logo 2" className="logo" />
        <img src="/img/vungtau.png" alt="Logo 3" className="logo" />
        <img src="/img/dien-hai.png" alt="Logo 4" className="logo" />
      </div>
    </div>
  );
};
